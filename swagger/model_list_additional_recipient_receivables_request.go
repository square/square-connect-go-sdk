...
// Defines the query parameters that can be included in a request to the [ListAdditionalRecipientReceivables](api-endpoint:Reporting-ListAdditionalRecipientReceivables) endpoint.
