...
type CreatePaymentRequest struct {
	...
	// The [Customer](#type-customer) ID of the customer associated with the payment. Required if the `source_id` refers to a card on file created using the Customers API.
