 ...
 * @param optional nil or *PaymentsApiListPaymentsOpts - Optional Parameters:
     * @param "BeginTime" (optional.String) -  Timestamp for the beginning of the reporting period, in RFC 3339 format. Inclusive. Default: The current time minus one year.
     ...
     * @param "LocationId" (optional.String) -  Limit results to the location supplied. By default, results are returned for the default (main) location associated with the merchant.
     * @param "Total" (optional.Int64) -  The exact amount in the total_money for a &#x60;Payment&#x60;.
     * @param "Last4" (optional.String) -  The last 4 digits of &#x60;Payment&#x60; card.
     * @param "CardBrand" (optional.String) -  The brand of &#x60;Payment&#x60; card. For example, &#x60;VISA&#x60;
