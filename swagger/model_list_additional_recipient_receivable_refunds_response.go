...
// Defines the fields that are included in the response body of a request to the [ListAdditionalRecipientReceivableRefunds](api-endpoint:Reporting-ListAdditionalRecipientReceivableRefunds) endpoint.  One of `errors` or `additional_recipient_receivable_refunds` is present in a given response (never both).
type ListAdditionalRecipientReceivableRefundsResponse struct {
	...
	ReceivableRefunds []AdditionalRecipientReceivableRefund `json:"receivable_refunds,omitempty"`
